...
@section('title','Status Peminjaman Ruangan')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <div class="header-title">
                <h4 class="card-title">Daftar Status Peminjaman Ruangan</h4>
            </div>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif($rp->status=='sedang diajukan')
                            ...
                            <td>
                                ...
                                <a class="btn btn-sm btn-icon">
                                    <form action="{{ route('statuspinjamruangan.destroy', $rp->id) }}" method="POST">
                                        @csrf
                                        @method('delete')
            ...
            <br>
            <a href="/cetak_pinjamruangan" button type="button" class="btn btn-primary">Print</button></a>
        </div>
    </div>
</div>
</div>
